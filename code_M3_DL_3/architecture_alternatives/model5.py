...
class CNNmodel5:
    def __init__(self, img_size=(256, 256), dump_path='dump/'):
        ...
        avgpool1_size = np.random.randint(2,10)
        avgpool2_size = np.random.randint(2,10)
        ...
        self.model.add(Conv2D(filters=conv1_filters,
                              ...
                              name='conv1'))
        self.model.add(AveragePooling2D(pool_size=(avgpool1_size, avgpool1_size),
                                    strides=None,
                                    name='avgpool1'))
        self.model.add(Conv2D(filters=conv2_filters,
                              ...
                              activation='relu',
                              name='conv2'))
        self.model.add(AveragePooling2D(pool_size=(avgpool2_size, avgpool2_size),
                                    strides=None,
                                    name='avgpool2'))
