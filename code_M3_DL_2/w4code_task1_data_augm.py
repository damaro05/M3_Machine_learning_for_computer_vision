...
train_data_dir = '/home/master04/data/MIT_400/validation_split'#'/share/datasets/MIT_split/train'
...
batch_size = 32
number_of_epoch = 85
script_identifier = 'task_1_400_data_aug'
plot_history = True
...
test_generator = clean_datagen.flow_from_directory(test_data_dir,
                                             target_size=(img_width, img_height),
                                             batch_size=batch_size,
                                             class_mode='categorical',
                                             shuffle=False)

validation_generator = clean_datagen.flow_from_directory(val_data_dir,
                                                   target_size=(img_width, img_height),
                                                   batch_size=batch_size,
                                                   class_mode='categorical')
#first training
